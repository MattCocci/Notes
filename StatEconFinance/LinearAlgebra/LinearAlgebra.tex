...
For a square $n\times n$ matrix $A$, a \emph{right eigenvector} $x$ (or,
more commonly, simply an \emph{eigenvector}) is a vector satisfying
\begin{equation}
  Ax = \lambda x
...
Finally, A \emph{left eigenvector} of matrix $A$ is a right eigenvector
of $A^*$.
\end{defn}
...
\section{Schur and QZ Decomposition}
