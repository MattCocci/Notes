...
result--$6^N$ to be precise. So as $N$ increases, the space of
your data grows exponentially, which typically necessitates 
...
variation along different dimensions is more explicit.
