...
\subsubsection{Normal Data (Known Variance)}
...
\subsubsection{Likelihood for Simple and Multiple Regression}
...
\newpage
\subsubsection{Informative Prior with iid $\beta_j \in \beta$}
