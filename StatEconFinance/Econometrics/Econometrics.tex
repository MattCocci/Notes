...
\clearpage
\subsection{Vector Processes}

Everything generalizes quite nicely to vector processes.
...
\begin{align*}
  ...
  &= \bso \qquad \forall k\neq 0
\end{align*}
We here place no restriction on $\bsSigma$ except for
...
multivariate filter. Then the filtered series
\begin{align*}
  \bsy_t = \bsH(L)\bsx_t
\end{align*}
has autocovariance generating function
\begin{align*}
  \bsg_{\bsx}(z) = \bsH(z)\bsg_{\bsy}(z)\bsH(z^{-1})'
\end{align*}
\end{prop}
