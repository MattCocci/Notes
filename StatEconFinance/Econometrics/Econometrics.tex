...
\begin{thm}\emph{(Martingale Difference CLT)}
Suppose that $\{X_n\}\ninf$ is a stationary and ergodic martingale
difference sequence with respect to the filtration $\{\sF_n\}\ninfz$,
i.e. $\E[X_n|\sF_{n-1}]=0$. Also suppose that $\E[X_nX_n']=\Sigma$. Then
\begin{align*}
  \frac{1}{N}\sumnN X_n \dto N(0,\Sigma)
\end{align*}
\end{thm}
...
\end{align*}
Given plain old $R^2$, it can be derived as
\begin{align*}
  R^2_A =
  1 -
