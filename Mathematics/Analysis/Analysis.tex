...
\newpage
\subsection{FTC for Lebesgue}

We now reconsider the Fundamental Theorem of Calculus in the context of the Lebesgue Integral. The resulting theorem will be slightly different than what we saw for the Riemann Integral. But before we do that, we'll need to define a few concepts that will make proving the theorem easier.
...
\begin{ex} (Cantor's Devil Staircase) To show why we need an \emph{absolutely} continuous function in the FTC for Lebesgue, we now show a function that is (1), 
\end{ex}
